...
public class PropertiesCredentialManager extends AbstractCredentialManager {
	...
	@Override
	public IDocumentumCredentials getCredentials(String userName, String password) {
	...
	private String getPropertiesLocation() {
		return AccessController.doPrivileged(new GetPropertyAction(PROPERTIES_FILE_LOCATION));
	}
